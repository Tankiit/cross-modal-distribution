...
def grad_desc(K,vocab,Ytrain,vocab_embeddings,Xtrain,train_tokens,max_iter=100000):
    converged=False
    iter=0
    #initial error
...
Xtrain_new=Xtrain[0:3]
Ytrain_new=Ytrain[0:3]
train_tokens_list_1=train_tokens[0]
train_tokens_list_2=train_tokens[1]
v='happy'

#print np.dot(K[0,1],grad_K_x_v(v,Xtrain_1,Xtrain_2,vocab,vocab_embeddings,train_tokens_list_1,train_tokens_list_2)).shape

print grad_L_x_v(v,K_new,Xtrain_new,Ytrain_new,vocab,vocab_embeddings,token_list).shape
